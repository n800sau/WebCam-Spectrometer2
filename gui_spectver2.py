...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.figure3.sizePolicy().hasHeightForWidth())
        self.figure3.setSizePolicy(sizePolicy)
        self.figure3.setObjectName(_fromUtf8("figure3"))
        self.horizontalLayout_3.addWidget(self.figure3)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 20, 154, 220))
